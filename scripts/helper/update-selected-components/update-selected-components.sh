...
optional_components_names=("Business Automation Insights" "Data Collector and Data Indexer" "Exposed Kafka Services" "Exposed Opensearch" "Workplace Assistant" "(Preview) Authoring Assistant" "Workflow Runtime MCP Server" "Application Connectors")
optional_components_cr_names=("bai" "pfs" "kafka" "opensearch" "workplace_assistant" "workflow_assistant" "workflow_runtime_mcp_server" "application_connectors")
