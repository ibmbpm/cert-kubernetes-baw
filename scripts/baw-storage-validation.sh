...
function show_help() {
    ...
    echo "  ./baw-storage-validation.sh -m performance_validation -n <BAW_NAMESPACE>"
    echo "  ./baw-storage-validation.sh -m storage_and_performance_validation -n <BAW_NAMESPACE>"
    echo
}
